# Contributing to AumAI Reasonflow
...
### Setup
```bash
git clone https://github.com/aumai/aumai-reasonflow.git
cd aumai-reasonflow
python -m venv .venv
...
### Good First Issues
New to the project? Start with issues labeled [`good first issue`](https://github.com/aumai/aumai-reasonflow/labels/good%20first%20issue).
...
- [GitHub Discussions](https://github.com/aumai/aumai-reasonflow/discussions)
